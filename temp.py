...
artistic_frame = Frame(mainWindow, highlightbackground='blue', highlightthickness=2, height=340, width=1520)
artistic_frame.place(x=10, y=360)
...
def upload_file_cartoonify():
    ...
    cartoon_label1.configure(image=img, text='ORIGINAL IMAGE', font=('Times', 18), compound='top', bg='black', fg='white')
    ...
    cartoon_label2.configure(image=grey_img, text='GREYSCALE IMAGE', font=('Times', 18), compound='top', bg='black', fg='white')

    anime_image = Image.open(path)
    resized_image = anime_image.resize((width, height))
    img = ImageTk.PhotoImage(resized_image)
    cartoon_label3.img = img
    cartoon_label3.configure(image=img, text='CARTOON IMAGE', font=('Times', 18), compound='top', bg='black', fg='white')
    ...
    cartoon_label4.configure(image=edge_img, text='EGDE IMAGE', font=('Times', 18), compound='top', bg='black', fg='white')
    ...
    cartoon_label5.configure(image=pen_img, text='PENCIL ART', font=('Times', 18), compound='top', bg='black', fg='white')
...
cartoon_label1 = Label(artistic_frame, text="My Image1")
cartoon_label1.place(x=90, y=10)

cartoon_label2 = Label(artistic_frame, text="My Image2")
cartoon_label2.place(x=370, y=10)

cartoon_label3 = Label(artistic_frame, text="My Image3")
cartoon_label3.place(x=650, y=10)

cartoon_label4 = Label(artistic_frame, text="My Image4")
cartoon_label4.place(x=930, y=10)

cartoon_label5 = Label(artistic_frame, text="My Image5")
